...
EqnetD = net(18,2,); % make a fitnet
EqnetD.layers{1}.transferFcn = 'purelin'; % have the actuvation be linear
EqnetD.layers{2}.transferFcn = 'purelin'; % have the actuvation be linear
