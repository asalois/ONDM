...
addpath('/home/alex/Documents/ONDM/gpu_test/sim_files')
...
for i = 1:11
	...
	parfor i = 1:20
qsmf_simulation_fft2(indx*20 + i, m(1, indx), m(2, indx), m(3, indx), m(4, indx), m(5, indx), m(6, indx), m(7, indx), m(8, indx))
end
