...
laserPowerdBmArray = -4; %-45.96:1.05:-30.96;   % Laser power [dBm] 
%laserPowerdBm = -2;  % Laser power [dBm]

totalLength = 10;   % total transmission length [km]
spanLength =10;     % span length [km]
segmentLength_1 = 0;  % first segement length,must < spanLengh [km]
...
percComp = 0;    % percentage of MPI compensation.  0 - full MPI, 100 - MPI fully compensated
stepLength = 100; % 250;  % fiber step length  [m]

fiberAeff_1 = 200;   % QSM fiber effective area   [um^2]
fiberAeff_2 = 150;   % EX3000 fiber effective area   [um^2]
fiberAlphadB_1 = 0.155;  % QSM fiber attenuation [dB/km]
fiberAlphadB_2 = 0.155;  % EX3000 fiber attenuation [dB/km]
